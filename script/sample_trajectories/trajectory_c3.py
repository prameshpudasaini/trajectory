...
acc_ent = round(3*3.2808, 2) # acceleration from entrance
...
s_est = v0 # estimated speed at entrance
d_acc_est = round((s_psl**2 - s_est**2) / (2*acc_ent), 2) # estimated distance of acceleration from entrance to reach PSL
...
s_est = v0 # estimated speed at entrance
d_acc_est = round((s_psl**2 - s_est**2) / (2*acc_ent), 2) # estimated distance of deceleration from entrance to reach PSL
...
DT.to_csv(r"D:\GitHub\trajectory\script\sample_trajectories\trajectory_c3.txt", sep = '\t', index = False)
